...
if(!class_exists("db_conn")){
    require_once("classes/db_conn.class.php");
        ...
        $sql = "SELECT * FROM course_list WHERE course_id = ?";
...
<div class="container-fluid">
    <form action="" id="course-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" autofocus id="name" required class="form-control form-control-sm rounded-0" value="<?=$data['course_code'] ?>">
        </div>
        <div class="form-group">
...
<div class="container-fluid">
    <form action="" id="course-form">
        <div class="form-group">
            <label for="name" class="control-label">Course Code</label>
            <input type="text" name="name" autofocus id="name" required class="form-control form-control-sm rounded-0" value="">
        </div>
        <div class="form-group">
            <label for="status" class="control-label">Status</label>
            <select name="status" id="status" class="form-select form-select-sm rounded-0">
